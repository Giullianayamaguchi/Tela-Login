...
<head>
    ...
    <title>Dynami :: Política de Privacidade</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <p>A sua privacidade é importante para nós. É política do Dynami respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=http://www.dominio.com>Dynami</a>, e outros sites que possuímos e operamos.</p>
                ...
                <h2>Política de Cookies Dynami</h2>
                ...
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Dynami oferece no site e com caráter enunciativo, mas não limitativo:</p>
                <ul>
                    ...
                    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Dynami, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                </ul>
